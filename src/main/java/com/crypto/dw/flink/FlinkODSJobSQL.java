...
public class FlinkODSJobSQL {
    ...
    public static void main(String[] args) throws Exception {
        ...
        StreamTableEnvironment tableEnv = envFactory.createTableEnvironment("flink-ods-sql-job", 8081);
        ...
        String groupId = config.getString("kafka.consumer.group-id.ods-sql");
